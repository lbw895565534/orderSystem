      ...
      <div class="box-input">
        <div id="input2" class="input">
          <div class="border" v-bind:class="{focus:form[0].focus}">
            ...
            <input type="text" class="input_username" placeholder="用户名" v-model="username" @focus="focus(0)"
              @blur="unFocus(0)">
          </div>
        </div>
        <div id="input2" class="input">
          <div class="border" v-bind:class="{focus:form[1].focus}">
            ...
            <input type="text" class="input_username" placeholder="姓名" v-model="name" @focus="focus(1)"
              @blur="unFocus(1)" readonly>
          </div>
        </div>
        <div id="input2" class="input">
          <div class="border" v-bind:class="{focus:form[2].focus}" @click="">
            ...
            <input type="text" class="input_username" placeholder="部门" v-model="section" @focus="select1()"
              @blur="unFocus(2)">
            <van-actionsheet v-model="show1" :actions="sections" cancel-text="取消" @select="onSelect1"
              @cancel="onCancel1" />
          </div>
        </div>
        <div id="input2" class="input">
          <div class="border" v-bind:class="{focus:form[3].focus}">
            ...
            <input type="text" class="input_username" placeholder="班组" v-model="term" @focus="select2()"
              @blur="unFocus(3)">
            <van-actionsheet v-model="show2" :actions="terms" cancel-text="取消" @select="onSelect2"
              @cancel="onCancel2" />
          </div>
        </div>
        <div id="input2" class="input">
          <div class="border" v-bind:class="{focus:form[4].focus}">
            ...
            <input type="text" class="input_username" placeholder="密码" v-model="password" @focus="focus(4)"
              @blur="unFocus(4)" readonly>
          </div>
        </div>
      </div>
      <div id="input4" class="input">
        <button class="login" @click="submit()">修&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改</button>
      </div>
    </div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      getUser() {
        axios.get('http://119.23.189.182:80/users/getUser', {
          params: {
          ...
          this.section = res.data[0].section;
      ...
      focus(i) {
        i == (3 | 2) ? this.form[i].focus = true : this.form[i].focus = false;
      },
      unFocus(i) {
        i == (3 | 2) ? this.form[i].focus = true : this.form[i].focus = false;
        i == 0 ? this.getUser():true;
      },
      select1() {
      ...
      submit() {       
        axios.get('http://119.23.189.182:80/users/updateUser', {
          params: {
            username: this.username,
            section: this.query,
            term: this.term,
